...
export default function SearchResults() {
  ...
  const handleGenerateQuiz = (videoId) => {

  }

  const handleGetVideoTranscript = async (videoId) => {
    console.log(videoId)
    axios.post("http://localhost:5000/user/get-youtube-transcript", {
        "video_id": videoId
    })
    .then((res) => {
                  ...
                  return (
                    ...
                    <div style={{ width: "300px" }}>
                      ...
                      <button className="btn btn-primary"
                        onClick={() => handleGetVideoTranscript(item.id.videoId)}
